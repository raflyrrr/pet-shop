...
<head>
	...
	<title>Kia Petshop | Laporan Data Produk Berdasarkan Kategori dan Subkategori</title>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<?php
					...
					$sql1 = "SELECT * FROM items  INNER JOIN brands ON brands.brd_id = items.brd_id INNER JOIN categories ON 
				...
				<?php } ?>
							...
							<?php
							$sql2 = mysqli_query($conn, "SELECT * FROM items INNER JOIN brands ON brands.brd_id = items.brd_id INNER JOIN categories ON 
