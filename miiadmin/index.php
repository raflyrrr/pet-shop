			...
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				?>
					<form action="index.php" method="post">
						...
						<div class="checkboxcss" style="color:#FFF; float:right; margin-bottom:2%;"><input type="checkbox" onchange="document.getElementById('form-password').type = this.checked ? 'text' : 'password'">Lihat Kata Sandi</div>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				<form action="?signup" method="post">
						...
						<div class="form-group input-group groups">
							<span class="input-group-addon icons"><i class="fa fa-user"></i></span>
							<input type="text" class="form-control form-input" name="user" placeholder="Masukkan nama pengguna Anda">
						</div>
						<span class="text-danger msg-error"><?php echo $userErr; ?></span>
						
						<div class="form-group input-group groups">
							<span class="input-group-addon icons"><i class="fa fa-key"></i></span>
							<input type="password" class="form-control form-input" name="pass" placeholder="Masukkan kata sandi">
						</div>
						<span class="text-danger msg-error"><?php echo $passErr; ?></span>
				...
				<p class="text-center new-account">Pernah jadi anggota? <a href="/miistore/miiadmin">Masuk</a></p>
			</div>
		</div>
	</div>
<?php
