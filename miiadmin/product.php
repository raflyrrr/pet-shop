...
<head>
	...
	<title>Kia Petshop | Data Produk</title>
...
<body>
	...
	<div id="wrapper">
		...
		<?php
							...
							$item = $cat = $scat = $brd = $bgImg = $image =  $detail =  $price = $disc = $stock = $available = "";
							$itemErr = $catErr = $scatErr = $brdErr = $bgImgErr =  $detailErr =  $priceErr = $discErr = $stockErr = $availableErr = "";
							$A = ""; $B = "";
							...
							if(isset($_POST['save'])){
								...
								if(!$error){
									...
									if(mysqli_num_rows($query) > 0){
										...
										$qry = "INSERT INTO items VALUES ('$itemid','$item','$cat','$scat','$brd','$bgImgNew','$filename','$detail','$price','$disc','$stock','$available','$regdate')";
		...
		<?php
					...
					$item = $cat = $scat = $brd =  $desc = $price = $detail  = $stock = $available = "";
					$itemErr = $catErr = $scatErr = $brdErr =  $detailErr = $priceErr = $stockErr = $availableErr = "";
					$A = ""; $B = "";
					...
					if(isset($_POST['update'])){
						...
						if(!$error){
							...
							mysqli_query($conn,"UPDATE items SET item_name='$item', cat_id='$cat', scat_id='$scat', brd_id='$brd', detail='$detail', price='$price', discount='$disc', stock='$stock', available ='$available' WHERE item_id='".$id."'");
							header('location: product.php');
						}
					}
