...
<head>
	...
	<title>Kia Petshop | Laporan Data Pemesanan</title>
						...
						<div style="margin-bottom: 10%;">
							...
							<div class="table-responsive">
								<table class="table table-bordered results">
									<?php
									include "library.php";
									$query = 'SELECT o1.creation_date, o1.order_id, o1.fullname, o1.item_name, o1.qty, o1.price, o1.disc, o1.afterdisc, o1.total FROM 
